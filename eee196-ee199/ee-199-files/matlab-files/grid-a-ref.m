...
target_solar_capacity_MW = [ 5170, 8716, 21230, 30738]; 
target_wind_capacity_MW  = [ 1337,  3239,  8349, 14201]; 
bess_capacity_MW         = [ 1572,  1572,  1572,  2438]; 
dependable_capacity_MW   = [18814, 20559, 20769, 28663]; 
 
% --- File Paths ---
base_dir  = 'D:\eee196-ee199\ee-199-files\matlab-files\data';
...
%% 3 & 4. Import 40 Years of CREZ Solar and Wind Data
...
for s_idx = 1:length(scenario_years)
    ...
    % Parameters for the current loop year
    ...
    % Export folder for current year
    output_dir = sprintf('D:\\eee196-ee199\\ee-199-files\\matlab-files\\Results\\Luzon\\REF\\%d', target_year);
    ...
    % Calculate Net Load
    net_load_40yr_MW = load_40yr - actual_solar_40yr_MW - actual_wind_40yr_MW;
